...
Tags: facebook like plugin, wordpress facebook like, admin, custom, face book, Facebook, facebook like, Facebook like widget, Facebook Widget, fb, fb like, featured, featured posts, Like, page, plugin, Post, posts, wordpress like, facebook recommend, wordpress facebook recommend
Author: AJ Batac
Version: 0.3
...
if( !function_exists('wp_fb_like_format') )
{
	function wp_fb_like_format( $align )
	{
		...
		$output = '<div id="wp_fb_like_button" style="margin:'.$margin.';float:'.$align.'"><iframe src="http://www.facebook.com/plugins/like.php?href='.rawurlencode($permalink).'&amp;layout='.$layout.'&amp;show_faces='.$show_faces.'&amp;action='.$action.'&amp;font='.$font.'&amp;colorscheme='.$colorscheme.'&amp;width='.$width.'&amp;height='.$height.'" scrolling="no" frameborder="0" allowTransparency="true" style="border:none; overflow:hidden; width: '.$width.'px; height: '.$height.'px;"></iframe></div>';
